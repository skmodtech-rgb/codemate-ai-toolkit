        ...
        <div className="max-w-4xl mx-auto">
            <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground">Transform a single topic into an engaging Twitter/X thread.</p>
                </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
                <div className="glass-card rounded-2xl p-6 h-fit">
                    <div className="space-y-4">
                        <div>
                            <label className="block text-sm font-medium text-foreground mb-2">What's your thread about?</label>
                            <textarea
                                value={topic}
                ...
                <div className="glass-card rounded-2xl p-6 min-h-[400px]">
                    ...
                    <div className="space-y-4">
                        {thread.length > 0 ? (
                            thread.map((t, index) => (
                                <div key={index} className="bg-background/30 rounded-xl p-4 relative group hover:ring-1 hover:ring-brand-500/50 transition-all">
