        ...
        <div className="max-w-6xl mx-auto pb-10">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-foreground">AI Document Q&A</h1>
                        <p className="text-muted-foreground">Paste any long document and chat with it to extract answers instantly.</p>
                    </div>
                </div>
            </div>
                    ...
                    <div className="flex-1 overflow-y-auto mb-4 pr-2 custom-scrollbar space-y-4">
                        {messages.length === 0 ? (
                            <div className="h-full flex flex-col items-center justify-center text-muted-foreground/50 text-center px-6">
                                ...
                                <p className="text-sm font-medium">Hello! I'm your Document Assistant.</p>
                                <p className="text-xs mt-2 opacity-60 max-w-sm">Paste a document on the left, then ask me anything about it here. I'll search the text and give you exact answers.</p>
                            </div>
                        ) : (
                                ...
                                {isLoading && (
                                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex gap-3 justify-start">
                                        ...
                                        <div className="p-4 rounded-2xl bg-background border border-input rounded-tl-sm flex items-center gap-2">
                                            ...
                                            <span className="text-sm text-muted-foreground animate-pulse">Searching document...</span>
                                        </div>
                                    </motion.div>
                                )}
                            </AnimatePresence>
