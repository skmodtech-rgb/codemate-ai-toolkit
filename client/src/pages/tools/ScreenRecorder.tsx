...
import { MonitorPlay, StopCircle, Play, Download, AlertCircle } from 'lucide-react';
...
export default function ScreenRecorder() {
    ...
    const startRecording = async () => {
        try {
            ...
            setError(err.message || 'Failed to start screen recording. Please check permissions.');
        }
    };
    ...
    return (
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="pb-12 flex flex-col max-w-4xl mx-auto">
            <div className="mb-6 flex flex-col items-center text-center">
                ...
                <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight">Screen Recorder</h1>
                <p className="text-foreground/60 mt-2 text-sm sm:text-base">Capture your screen and audio directly in the browser.</p>
            </div>
                ...
                <div className="flex flex-col items-center justify-center min-h-[300px]">
                    {!recording && !videoUrl && (
                        <div className="text-center w-full max-w-md">
                            ...
                            <p className="text-foreground/60 mb-8">Click below to choose which screen, window, or tab to share. System audio can also be captured if selected.</p>
                    ...
                    {recording && (
                        <div className="text-center w-full max-w-md">
                            ...
                            <h3 className="text-xl font-bold mb-2 text-red-500 animate-pulse">Recording active...</h3>
                            <p className="text-foreground/60 mb-8">Your screen is currently being recorded.</p>
                    ...
                    {!recording && videoUrl && (
                        <div className="w-full">
                            ...
                            <div className="relative rounded-xl overflow-hidden bg-black/60 mb-6 border border-border shadow-2xl">
                                <video src={videoUrl} controls className="w-full max-h-[500px] block outline-none" />
                            </div>
