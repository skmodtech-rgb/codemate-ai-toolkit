    ...
    return (
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="pb-12 h-full flex flex-col">
            <div className="mb-6">
                ...
                <p className="text-foreground/60 mt-2">Easily encode strings to Base64 format or decode them back to plain text.</p>
            </div>
            ...
            <div className="glass-card rounded-2xl p-6 flex-1 flex flex-col gap-6 w-full max-w-5xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 flex-1">
                    ...
                    <div className="flex flex-col gap-2 relative h-full">
                        <div className="flex justify-between items-center">
                            <label className="text-sm font-semibold text-foreground/80">Output ({mode === 'encode' ? 'Base64' : 'Text'})</label>
                            <button 
                                onClick={handleCopy}
                                disabled={!output}
                        ...
                        <div className={`p-4 rounded-lg flex-1 overflow-auto font-mono text-sm ring-1 ring-inset ${error ? 'bg-red-500/10 ring-red-500/50 text-red-400' : 'bg-background ring-border text-foreground'}`}>
                ...
                <div className="flex lg:justify-center">
                    <button onClick={handleProcess} className="btn-primary w-full md:w-auto h-12 px-8 flex gap-2">
