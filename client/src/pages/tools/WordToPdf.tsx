...
export default function WordToPdf() {
    ...
    const downloadAsPdf = async () => {
        ...
        try {
            ...
            const blocks: { text: string; isBold: boolean; isHeading: boolean; fontSize: number }[] = [];
            ...
            <div className="glass-card rounded-2xl p-4 sm:p-6 w-full max-w-4xl mx-auto flex flex-col gap-6">
                {!file ? (
                    <div 
                        ...
                        onClick={() => { const input = document.createElement('input'); input.type = 'file'; input.accept = '.docx,.doc'; input.onchange = (e) => { const f = (e.target as HTMLInputElement).files?.[0]; if (f) handleFile(f); }; input.click(); }}
                    >
