...
export default function UnitConverter() {
    const [category, setCategory] = useState<'Length' | 'Mass' | 'Volume' | 'Temperature' | 'Time'>('Length');
    ...
    const handleCategoryChange = (c: keyof typeof unitOptions) => {
        setCategory(c);
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="pb-12 flex flex-col max-w-3xl mx-auto">
            ...
            <div className="glass-card rounded-2xl p-6 sm:p-8 mb-6 shadow-xl border border-border">
                ...
                <div className="flex flex-wrap gap-2 justify-center mb-8">
                    {(Object.keys(unitOptions) as Array<keyof typeof unitOptions>).map((c) => (
                        <button 
                            key={c}
