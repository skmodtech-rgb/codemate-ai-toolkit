        ...
        <div className="max-w-4xl mx-auto">
            <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground">Generate engaging captions for Instagram, TikTok, or LinkedIn.</p>
                </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
                <div className="glass-card rounded-2xl p-6">
                    <div className="space-y-4">
                        <div>
                            <label className="block text-sm font-medium text-foreground mb-2">What is your post about?</label>
                            <textarea
                                value={topic}
