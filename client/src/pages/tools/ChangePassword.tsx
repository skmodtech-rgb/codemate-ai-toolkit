...
import { Lock, Eye, EyeOff, Save, Loader2, Check, ShieldCheck } from 'lucide-react';
...
export default function ChangePassword() {
    ...
    return (
        ...
        >
            <div className="mb-8">
                <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-foreground">Change Password</h1>
