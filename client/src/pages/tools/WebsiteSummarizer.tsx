        ...
        <div className="max-w-6xl mx-auto pb-10">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-foreground">Website Summarizer</h1>
                        <p className="text-muted-foreground">Paste the text of any large website or article to extract an instant executive summary.</p>
                    </div>
                </div>
            </div>
                        ...
                        <AnimatePresence mode="popLayout">
                            {result ? (
                                ...
                                >
                                    ...
                                    <p className="text-sm font-medium">The summary will appear here.</p>
                                    <p className="text-xs mt-2 opacity-60 max-w-xs">We'll distill paragraphs of marketing or technical text into a succinct, scannable format.</p>
                                </motion.div>
                            )}
                        </AnimatePresence>
                    </div>
