    ...
    return (
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="pb-12 flex flex-col max-w-4xl mx-auto">
            <div className="mb-6">
                ...
                <p className="text-foreground/60 mt-2 text-sm sm:text-base">Convert any text into natural-sounding speech.</p>
            </div>
            ...
            <AnimatePresence>
                {resultUrl && !loading && (
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="glass-card rounded-2xl p-6 bg-pink-500/5 border-pink-500/20">
                        ...
                        <div className="w-full bg-background rounded-full p-2 border border-border shadow-inner">
                            <audio src={resultUrl} controls className="w-full h-12" autoPlay />
                        </div>
                    </motion.div>
                )}
            </AnimatePresence>
