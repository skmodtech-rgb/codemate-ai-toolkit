...
import { MessageSquare, Twitter, Copy, Check, Sparkles, Send } from 'lucide-react';
    ...
    return (
        <div className="max-w-4xl mx-auto">
            <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-foreground">Tweet Generator</h1>
                    <p className="text-muted-foreground">Generate highly engaging tweets tailored to your audience.</p>
                </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
                <div className="glass-card rounded-2xl p-6">
                    <div className="space-y-4">
                        <div>
                            <label className="block text-sm font-medium text-foreground mb-2">What's your tweet about?</label>
                            <textarea
                                value={topic}
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                {['engaging', 'professional', 'funny', 'educational'].map((t) => (
                                    <button
                                        key={t}
                                        onClick={() => setTone(t)}
                                        className={cn(
