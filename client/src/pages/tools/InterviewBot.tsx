        ...
        <div className="max-w-4xl mx-auto pb-10">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-foreground">AI Mock Interview Bot</h1>
                        <p className="text-muted-foreground">Generate tailored interview questions and brilliant answers for any role.</p>
                    </div>
                </div>
            </div>
                    ...
                    <div className="grid sm:grid-cols-2 gap-4 mb-4">
                        <div>
                            <label className="block text-sm font-medium text-foreground mb-2 flex items-center gap-2">
                                <Briefcase className="w-4 h-4 text-brand-500" /> Target Role / Job Title
                            </label>
                            <input
                                type="text"
                                value={role}
                        ...
                        <AnimatePresence mode="popLayout">
                            {result ? (
                                ...
                                >
                                    ...
                                    <p className="text-sm font-medium">Your customized interview questions will appear here.</p>
                                    <p className="text-xs mt-2 opacity-60 max-w-sm">We'll provide behavioral frameworks and brilliant response examples to help you ace your interview.</p>
                                </motion.div>
                            )}
                        </AnimatePresence>
                    </div>
