    ...
    return (
        <div className="h-full flex flex-col items-center justify-center text-center max-w-lg mx-auto p-6">
            <div className="w-24 h-24 rounded-3xl bg-accent border border-border shadow-2xl flex items-center justify-center mb-8 relative">
                <Settings className="w-12 h-12 text-brand-500 animate-spin" style={{ animationDuration: '4s' }} />
            ...
            <h1 className="text-3xl font-bold tracking-tight mb-4">{getTitle(location.pathname)}</h1>
            <p className="text-foreground/60 mb-8 leading-relaxed">
                This feature is currently in active development by the CodeMate team. 
                We are training the AI models and setting up dedicated infrastructure. Check back soon!
            </p>
