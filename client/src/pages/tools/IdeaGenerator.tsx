        ...
        <div className="max-w-6xl mx-auto pb-10">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-foreground">AI Startup Idea Generator</h1>
                        <p className="text-muted-foreground">Turn any problem statement into 3 validated startup concepts with pros, cons, and moats.</p>
                    </div>
                </div>
            </div>
            ...
            <div className="grid lg:grid-cols-12 gap-6 h-[700px]">
                ...
                <div className="lg:col-span-4 glass-card rounded-3xl p-6 flex flex-col h-full">
                    <div className="space-y-6">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-foreground mb-2">Industry / Niche</label>
                            <input
                                type="text"
                                value={industry}
                        ...
                        <AnimatePresence mode="popLayout">
                            {result ? (
                                ...
                                >
                                    ...
                                    <p className="text-sm font-medium">Your innovative startup ideas will appear here.</p>
                                    <p className="text-xs mt-2 opacity-60 max-w-sm">We'll provide the pitch, mechanics, risks, and moats for 3 unique concepts based on your problem.</p>
                                </motion.div>
                            )}
                        </AnimatePresence>
                    </div>
