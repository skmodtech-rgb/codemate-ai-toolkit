...
export default function CssMinifier() {
    const [input, setInput] = useState('.header { color: #fff; margin: 20px; } \n .footer { background: black; }');
    ...
    return (
        ...
        >
            <div className="mb-6 flex flex-col items-center text-center">
                ...
                <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight">CSS Minifier</h1>
                <p className="text-foreground/60 mt-2 text-sm sm:text-base">Compress your CSS by removing all unnecessary whitespace and comments.</p>
            </div>

            <div className="grid lg:grid-cols-2 gap-8">
                <div className="space-y-4">
                    <div className="flex items-center justify-between">
                        <label className="text-xs font-bold text-foreground/50 uppercase tracking-widest">Raw CSS</label>
                ...
                <div className="space-y-4">
                    <div className="flex items-center justify-between">
                        <label className="text-xs font-bold text-foreground/50 uppercase tracking-widest">Minified Result</label>
                        {output && (
                    ...
                    <div className="w-full h-96 bg-black/20 border border-border rounded-2xl p-6 font-mono text-sm overflow-auto break-all relative group bg-grid-pattern">
                        {output ? (
                            ...
                            <div className="h-full flex flex-col items-center justify-center opacity-20 text-center space-y-4">
                                ...
                                <p className="font-bold uppercase tracking-widest">Click Minify to compress</p>
                            </div>
                        )}
                    </div>
                    <button
